...
import {
  Dices, Home, Building2, Coins, HandCoins, Lock, Landmark,
  Scale, ShieldAlert, TrendingUp, Skull, Sparkles, MousePointerClick,
} from "lucide-react";
...
// Single source of truth for the rulebook: shared by the in-game guide modal and
// the public docs page.
export function chaptersFor(locale: Locale): Chapter[] {
  return locale === "en" ? CHAPTERS_EN : CHAPTERS_ID;
}
